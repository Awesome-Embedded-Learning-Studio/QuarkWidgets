 ...
 *     aex::WeakPtr<qw::core::IMotionSpec>(&motionSpec),
 *     SlideDirection::Up,
 *     this);
 ...
 * @endcode
 */
class QW_EXPORT CFMaterialSlideAnimation : public ICFTimingAnimation {
    Q_OBJECT
  ...
  public:
     ...
     * @ingroup       ui_components_material
     */
    explicit CFMaterialSlideAnimation(qw::core::IMotionSpec* spec, SlideDirection direction,
