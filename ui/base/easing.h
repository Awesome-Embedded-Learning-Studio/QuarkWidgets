 ...
 * @ingroup ui
 */
QW_EXPORT QEasingCurve fromEasingType(const Type t);
 ...
 * @ingroup ui
 */
QW_EXPORT QEasingCurve custom(float x1, float y1, float x2, float y2);
 ...
 * @ingroup ui
 */
QW_EXPORT SpringPreset springGentle();
 ...
 * @ingroup ui
 */
QW_EXPORT SpringPreset springBouncy();
 ...
 * @ingroup ui
 */
QW_EXPORT SpringPreset springStiff();
