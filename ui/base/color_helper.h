 ...
 * @ingroup ui
 */
QW_EXPORT CFColor blend(const CFColor& base, CFColor& overlay, float ratio);
 ...
 * @ingroup ui
 */
QW_EXPORT CFColor elevationOverlay(CFColor& surface, CFColor& primary, int elevation);
 ...
 * @ingroup ui
 */
QW_EXPORT float contrastRatio(CFColor& a, CFColor& b);
 ...
 * @ingroup ui
 */
QW_EXPORT QList<CFColor> tonalPalette(CFColor keyColor);
