 ...
 * @ingroup ui
 */
QW_EXPORT QPainterPath roundedRect(const QRectF& rect, ShapeScale scale);
 ...
 * @ingroup ui
 */
QW_EXPORT QPainterPath roundedRect(const QRectF& rect, float radius);
 ...
 * @ingroup ui
 */
QW_EXPORT QPainterPath roundedRect(const QRectF& rect, float topLeft, float topRight,
