 ...
 * @ingroup      ui
 */
QW_EXPORT float lerp(float a, float b, float t);
 ...
 * @ingroup         ui
 */
QW_EXPORT float clamp(float value, float min, float max);
 ...
 * @ingroup         ui
 */
QW_EXPORT float remap(float value, float inMin, float inMax, float outMin, float outMax);
 ...
 * @ingroup      ui
 */
QW_EXPORT float cubicBezier(float x1, float y1, float x2, float y2, float t);
 ...
 * @ingroup             ui
 */
QW_EXPORT std::pair<float, float> springStep(float position, float velocity, float target,
 ...
 * @ingroup      ui
 */
QW_EXPORT float lerpAngle(float a, float b, float t);
