 ...
 * @brief Comprehensive unit tests for qw::base::device::CanvasUnitHelper
 *
 * Test Coverage:
...
TEST(CanvasUnitHelperTest, Dpi_Formula) {
    ...
    for (qreal dpr = 0.5; dpr <= 4.0; dpr += 0.5) {
        qw::base::device::CanvasUnitHelper helper(dpr);
...
TEST(CanvasUnitHelperTest, BreakPoint_Compact) {
    ...
    EXPECT_EQ(helper.breakPoint(300.0),
              qw::base::device::CanvasUnitHelper::BreakPoint::Compact);
...
TEST(CanvasUnitHelperTest, BreakPoint_Medium) {
    ...
    EXPECT_EQ(helper.breakPoint(600.0), qw::base::device::CanvasUnitHelper::BreakPoint::Medium);
    EXPECT_EQ(helper.breakPoint(700.0), qw::base::device::CanvasUnitHelper::BreakPoint::Medium);
    EXPECT_EQ(helper.breakPoint(839.0), qw::base::device::CanvasUnitHelper::BreakPoint::Medium);
    EXPECT_EQ(helper.breakPoint(839.99),
              qw::base::device::CanvasUnitHelper::BreakPoint::Medium);
}
...
TEST(CanvasUnitHelperTest, BreakPoint_Expanded) {
    ...
    EXPECT_EQ(helper.breakPoint(840.0),
              qw::base::device::CanvasUnitHelper::BreakPoint::Expanded);
...
TEST(CanvasUnitHelperTest, BreakPoint_Zero) {
    ...
    EXPECT_EQ(helper.breakPoint(0.0), qw::base::device::CanvasUnitHelper::BreakPoint::Compact);
}
...
TEST(MaterialDesignBreakpoints, Medium_Range) {
    ...
    EXPECT_EQ(helper.breakPoint(600.0), qw::base::device::CanvasUnitHelper::BreakPoint::Medium);
    EXPECT_EQ(helper.breakPoint(720.0), qw::base::device::CanvasUnitHelper::BreakPoint::Medium);
    EXPECT_EQ(helper.breakPoint(839.0), qw::base::device::CanvasUnitHelper::BreakPoint::Medium);
}
...
TEST(CanvasUnitHelperIntegration, FontScaling) {
    ...
    qw::base::device::CanvasUnitHelper helper1x(1.0);
    qw::base::device::CanvasUnitHelper helper2x(2.0);
    qw::base::device::CanvasUnitHelper helper3x(3.0);
...
TEST(CanvasUnitHelperEdgeCases, VerySmallDPR) {
    qw::base::device::CanvasUnitHelper helper(0.5);
...
TEST(CanvasUnitHelperEdgeCases, LargeDPR) {
    qw::base::device::CanvasUnitHelper helper(4.0);
