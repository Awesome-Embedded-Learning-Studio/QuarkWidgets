 ...
 * @brief Comprehensive unit tests for qw::base::Easing namespace
 *
 * Test Coverage:
...
TEST(EasingTest, FromEasingType_Emphasized) {
    QEasingCurve curve =
        qw::base::Easing::fromEasingType(qw::base::Easing::Type::Emphasized);
...
TEST(EasingTest, FromEasingType_EmphasizedDecelerate) {
    QEasingCurve curve =
        qw::base::Easing::fromEasingType(qw::base::Easing::Type::EmphasizedDecelerate);
...
TEST(EasingTest, FromEasingType_EmphasizedAccelerate) {
    QEasingCurve curve =
        qw::base::Easing::fromEasingType(qw::base::Easing::Type::EmphasizedAccelerate);
...
TEST(EasingTest, FromEasingType_Standard) {
    QEasingCurve curve = qw::base::Easing::fromEasingType(qw::base::Easing::Type::Standard);
...
TEST(EasingTest, FromEasingType_StandardDecelerate) {
    QEasingCurve curve =
        qw::base::Easing::fromEasingType(qw::base::Easing::Type::StandardDecelerate);
...
TEST(EasingTest, FromEasingType_StandardAccelerate) {
    QEasingCurve curve =
        qw::base::Easing::fromEasingType(qw::base::Easing::Type::StandardAccelerate);
...
TEST(EasingTest, FromEasingType_Linear) {
    QEasingCurve curve = qw::base::Easing::fromEasingType(qw::base::Easing::Type::Linear);
...
TEST(MaterialDesignEasing, Standard_IsSimilarToEmphasized) {
    ...
    QEasingCurve standard =
        qw::base::Easing::fromEasingType(qw::base::Easing::Type::Standard);
...
TEST(CustomEasing, BasicBezier) {
    QEasingCurve curve = qw::base::Easing::custom(0.25f, 0.1f, 0.25f, 1.0f);
...
TEST(CustomEasing, EaseInQuad) {
    ...
    QEasingCurve curve = qw::base::Easing::custom(0.5f, 0.0f, 1.0f, 1.0f);
...
TEST(CustomEasing, EaseOutQuad) {
    ...
    QEasingCurve curve = qw::base::Easing::custom(0.0f, 0.0f, 0.5f, 1.0f);
...
TEST(CustomEasing, ExtremeControlPoints) {
    ...
    QEasingCurve curve = qw::base::Easing::custom(0.0f, -0.5f, 1.0f, 1.5f);
...
TEST(SpringPresets, SpringGentle) {
    qw::base::Easing::SpringPreset preset = qw::base::Easing::springGentle();
...
TEST(SpringPresets, SpringBouncy) {
    qw::base::Easing::SpringPreset preset = qw::base::Easing::springBouncy();
...
TEST(SpringPresets, SpringStiff) {
    qw::base::Easing::SpringPreset preset = qw::base::Easing::springStiff();
...
TEST(SpringPresets, GentleHasLowestStiffness) {
    auto gentle = qw::base::Easing::springGentle();
    auto bouncy = qw::base::Easing::springBouncy();
    auto stiff = qw::base::Easing::springStiff();
...
TEST(EasingCurveValidation, AllTypes_StartAtZero) {
    auto types = {qw::base::Easing::Type::Emphasized,
                  qw::base::Easing::Type::EmphasizedDecelerate,
                  qw::base::Easing::Type::EmphasizedAccelerate,
                  qw::base::Easing::Type::Standard,
                  qw::base::Easing::Type::StandardDecelerate,
                  qw::base::Easing::Type::StandardAccelerate,
                  qw::base::Easing::Type::Linear};

    for (auto type : types) {
        QEasingCurve curve = qw::base::Easing::fromEasingType(type);
...
TEST(EasingProgressValues, AtZeroProgress) {
    auto types = {qw::base::Easing::Type::Emphasized, qw::base::Easing::Type::Linear,
                  qw::base::Easing::Type::Standard};
...
TEST(EasingProgressValues, AtQuarterProgress) {
    ...
    QEasingCurve linear = qw::base::Easing::fromEasingType(qw::base::Easing::Type::Linear);
    QEasingCurve easeIn =
        qw::base::Easing::fromEasingType(qw::base::Easing::Type::EmphasizedAccelerate);
