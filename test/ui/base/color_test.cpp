/**
 * @file color_test.cpp
 * @brief Comprehensive unit tests for qw::base::CFColor class
 *
 * Test Coverage:
...
TEST(CFColorTest, ConstructFromHCT_Basic) {
    qw::base::CFColor color(180.0f, 50.0f, 50.0f); // Cyan-ish
...
TEST(CFColorTest, ConstructFromHCT_Clamping) {
    ...
    qw::base::CFColor color(500.0f, 200.0f, 150.0f);
...
TEST(CFColorTest, ConstructFromHCT_NegativeValues) {
    qw::base::CFColor color(-10.0f, -5.0f, -10.0f);
...
TEST(CFColorTest, ConstructFromHCT_ZeroChroma_Grayscale) {
    qw::base::CFColor color(0.0f, 0.0f, 50.0f); // Gray
...
TEST(CFColorTest, ConstructFromHCT_Red) {
    qw::base::CFColor color(0.0f, 100.0f, 50.0f); // Red
...
TEST(CFColorTest, ConstructFromHCT_Green) {
    qw::base::CFColor color(120.0f, 80.0f, 50.0f); // Green
...
TEST(CFColorTest, ConstructFromHCT_Blue) {
    qw::base::CFColor color(240.0f, 80.0f, 50.0f); // Blue
...
TEST(CFColorTest, ConstructFromHCT_LightTone) {
    qw::base::CFColor color(0.0f, 50.0f, 90.0f); // Light color
...
TEST(CFColorTest, ConstructFromHCT_DarkTone) {
    qw::base::CFColor color(0.0f, 50.0f, 10.0f); // Dark color
...
TEST(CFColorTest, RelativeLuminance_Green) {
    qw::base::CFColor color(Qt::green);
    float lum = color.relativeLuminance();
...
TEST(CFColorTest, RoundTrip_RGBtoHCTtoRGB) {
    ...
    qw::base::CFColor original(originalRgb);

    // Create new color from HCT
    qw::base::CFColor fromHct(original.hue(), original.chroma(), original.tone());
...
TEST(CFColorTest, Hue_BoundaryValues) {
    qw::base::CFColor color1(0.0f, 50.0f, 50.0f);
    EXPECT_FLOAT_EQ(color1.hue(), 0.0f);

    qw::base::CFColor color2(360.0f, 50.0f, 50.0f);
    EXPECT_FLOAT_EQ(color2.hue(), 360.0f);
}

TEST(CFColorTest, Chroma_BoundaryValues) {
    qw::base::CFColor color1(180.0f, 0.0f, 50.0f);
    EXPECT_FLOAT_EQ(color1.chroma(), 0.0f);

    qw::base::CFColor color2(180.0f, 150.0f, 50.0f);
    EXPECT_FLOAT_EQ(color2.chroma(), 150.0f);
}

TEST(CFColorTest, Tone_BoundaryValues) {
    qw::base::CFColor color1(180.0f, 50.0f, 0.0f);
    EXPECT_FLOAT_EQ(color1.tone(), 0.0f);

    qw::base::CFColor color2(180.0f, 50.0f, 100.0f);
...
TEST(CFColorTest, CopyConstructor) {
    qw::base::CFColor original("#FF00FF");
    qw::base::CFColor copy(original);
...
TEST(CFColorTest, MultipleConstructorsSameColor) {
    ...
    qw::base::CFColor fromHex("#FF0000");
    qw::base::CFColor fromQColor(QColor(255, 0, 0));
...
TEST(CFColorTest, HCTRangeValidation) {
    ...
    qw::base::CFColor color(500.0f, -50.0f, 150.0f);
